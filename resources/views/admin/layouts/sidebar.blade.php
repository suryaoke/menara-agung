         ...
         <div class="collapse navbar-collapse" id="sidebar-menu">
             <ul class="navbar-nav pt-lg-3">
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu {{ Request::routeIs('admin.supplier.*') ? 'show' : '' }}">
                         <a class="dropdown-item" href="{{ route('admin.supplier.index') }}" rel="noopener">
                             All Supplier
                         </a>
                     </div>
                 </li>
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu {{ Request::routeIs('admin.category.*') ? 'show' : '' }}">
                         <a class="dropdown-item" href="{{ route('admin.category.index') }}" rel="noopener">
                             All Category
                         </a>
                     </div>
                 </li>
